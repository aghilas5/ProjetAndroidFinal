...
public class MonRecyclerViewAdapterMedecin  extends RecyclerView.Adapter<MonRecyclerViewAdapterMedecin.ConteneurDeDonnee>{
    private List<Medecin> donnees;
    private static DetecteurDeClicSurRecycler detecteurDeClicSurRecycler;


    public MonRecyclerViewAdapterMedecin(List<Medecin> donnees) {
    ...
    public ConteneurDeDonnee onCreateViewHolder(ViewGroup parent, int
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recycler_view_liste_medecins, parent, false);
        return new ConteneurDeDonnee(view);
    }
    @Override
    public void onBindViewHolder(ConteneurDeDonnee conteneur, int
            position) {
        conteneur.Nom.setText("Dr. "+donnees.get(position).getNom()+"  "+donnees.get(position).getPrenom());
