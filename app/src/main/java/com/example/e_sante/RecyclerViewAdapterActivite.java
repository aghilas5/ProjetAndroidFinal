...
public class RecyclerViewAdapterActivite  extends RecyclerView.Adapter<RecyclerViewAdapterActivite.ConteneurDeDonnee> {

    private List<Activite> donnees;
    private static DetecteurDeClicSurRecycler detecteurDeClicSurRecycler;

    public RecyclerViewAdapterActivite(List<Activite> donnees) {
    ...
    public ConteneurDeDonnee onCreateViewHolder(ViewGroup parent, int
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.recyclerview_activite, parent, false);
